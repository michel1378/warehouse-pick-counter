...
export function EmployeeForm({ employee }: { employee?: Employee }) {
  ...
  return <SubmitForm action={saveEmployee} className="employee-form">
    ...
    <fieldset><legend>Доступы</legend><label><input type="checkbox" name="permissions" value="picking" defaultChecked={permissions.includes("picking")} /> Сборка заказов</label><label><input type="checkbox" name="permissions" value="attendance" defaultChecked={permissions.includes("attendance")} /> Отметки</label><label><input type="checkbox" name="permissions" value="reviews" defaultChecked={permissions.includes("reviews")} /> Отзывы</label></fieldset>
  </SubmitForm>;
}
