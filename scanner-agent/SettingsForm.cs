...
internal sealed class SettingsForm : Form
{
    ...
    private readonly Label _identify = new() { AutoSize = true }; private bool _waiting; private readonly RawInput _raw;
    ...
    {
        _raw = raw; Text = "Настройка складского сканера"; Width = 700; Height = 390; StartPosition = FormStartPosition.CenterScreen; MaximizeBox = false;
        ...
        raw.KeyReceived += OnRawKey; FormClosed += (_, _) => raw.KeyReceived -= OnRawKey;
    }
